...
### Project Structure
```
├── Mduong2sapplication1.xcodeproj  - it lets you create and modify Xcode projects from Ruby.      
│ 
├── Mduong2sapplication1            - Application components folder
